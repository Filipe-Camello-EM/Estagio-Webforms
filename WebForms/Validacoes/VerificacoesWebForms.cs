...
{
    public class VerificacoesWebForms
    {
        ...
        {
            return (aluno.Matricula == 0 || aluno.Matricula == null);
        }
        ...
        {
            return (String.IsNullOrEmpty(aluno.Nome) || String.IsNullOrEmpty(aluno.Nome.Trim()));
        }
